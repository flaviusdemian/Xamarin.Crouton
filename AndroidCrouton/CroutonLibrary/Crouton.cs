...
{
    public class Crouton : Java.Lang.Object
    {
  ...
  private void measureCroutonView() 
  {
    ...
    if (null != viewGroup) 
    {
      widthSpec = View.MeasureSpec.MakeMeasureSpec(viewGroup.MeasuredWidth, View.MeasureSpec.AT_MOST);
    } 
    else 
    {
      widthSpec = View.MeasureSpec.MakeMeasureSpec(activity.Window.DecorView.MeasuredWidth, View.MeasureSpec.AT_MOST);
    }
  ...
  private FrameLayout initializeCroutonViewGroup(Resources resources) 
  {
    ...
    croutonView.ActionBar.LayoutParams = 
        new FrameLayout.LayoutParams(width != 0 ? width : FrameLayout.LayoutParams.MatchParent, height));
  ...
  private RelativeLayout initializeContentView(Resources resources) 
  {
    ...
    if (null != image) {
      textParams.AddRule(RelativeLayout.RIGHT_OF, image.Id);
    }
  ...
  private void setTextWithCustomFont(TextView text, String fontName) {
    if (this.text != null) {
      ...
      s.SetSpan(new TypefaceSpan(text.Context, fontName), 0, s.Length(),
  ...
  private ImageView initializeImageView() 
  {
    ...
    imageParams.AddRule(RelativeLayout.CENTER_VERTICAL, RelativeLayout.TRUE);
      ...
      image.LayoutParameters = mageParams;
